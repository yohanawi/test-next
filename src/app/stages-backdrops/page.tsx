...
export async function generateMetadata(): Promise<Metadata> {
    ...
    try {
        const { data } = await client.query({ query: GET_BACKDROP_DATA, variables: { locale: "en" }, });
        const seo = data?.backdropPage?.data?.attributes?.meta_data || {};
        ...
        return {
            title: seo.metaTitle || "Stages Backdrops | XESS Events",
            description: seo.metaDescription || "Learn more about XESS Events and our story.",
            metadataBase: new URL("https://xessevents.com"),
            alternates: {
                canonical: seo.canonicalURL || "https://xessevents.com/stages-backdrops",
                languages: {
                    "en": "https://xessevents.com/stages-backdrops",
                },
            },
            ...
            openGraph: {
                title: seo.metaTitle || "Stages Backdrops | XESS Events",
                description: seo.metaDescription || "Learn more about XESS Events and our story.",
                url: "https://xessevents.com/stages-backdrops",
                type: "website",
                images: [imageUrl],
            },
            twitter: {
        ...
        return {
            title: "Stages Backdrops | XESS Events",
