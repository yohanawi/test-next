    ...
    return (
        <>
            ...
            <section className="relative w-full lg:h-[400px] h-[300px] flex items-center text-center justify-center">
                <Image src={blogDetail?.HeroSec?.bgImage?.data?.attributes?.url ? `${baseUrl}${blogDetail.HeroSec.bgImage.data.attributes.url}` : "/images/default-banner.jpg"} layout="fill" objectFit="cover" alt={blogDetail?.HeroSec?.title || "Blog Banner"} />
            ...
            <section className="bg-white">
                <div className="grid py-10 lg:grid-cols-3 lg:px-48 3xl:px-72 md:px-28 px-14 md:py-12 lg:py-20 lg:gap-10 md:gap-14">
                    <div className="lg:col-span-2">
                        <h1 className="text-2xl font-semibold text-gray-900 uppercase md:text-3xl">
                            {blogDetail?.title}
                        </h1>
