...
import ContractorsAbuDhabi from "./ContractorsAbuDhabi";
...
export async function generateMetadata(): Promise<Metadata> {
    ...
    try {
        ...
        return {
            title: "Exhibition Stand Contractors in Abu Dhabi | XESS Events",
...
export default function ContractorsInAbuDhabi() {
    return <ContractorsAbuDhabi />;
}
