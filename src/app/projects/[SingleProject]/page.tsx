        ...
        <>
            ...
            <section className="bg-white lg:py-12">
                <div className="text-center">
                    <h1 className="pb-2 text-xl text-black lg:text-4xl md:text-3xl">{gallerySec?.title}</h1>
            ...
            {bannerSec && (bannerSec.bgImg?.data?.attributes?.url || bannerSec?.title || bannerSec?.description) ? (
                <section className="bg-[#f6f6f6] text-center lg:py-20 md:py-16 py-10  bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url('${bgImageUrl}')` }}>
                    <div className="container px-10 mx-auto">
                        <h1 className="text-2xl text-center text-white uppercase md:text-3xl lg:text-4xl md:mx-20">{bannerSec?.title}</h1>
