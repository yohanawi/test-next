...
import ContractorsSharjah from "./ContractorsSharjah";
...
export async function generateMetadata(): Promise<Metadata> {
    ...
    try {
        ...
        return {
            title: "Exhibition Stand Contractors in Sharjah | XESS Events",
...
export default function ContractorsInSharjah() {
    return <ContractorsSharjah />;
}
