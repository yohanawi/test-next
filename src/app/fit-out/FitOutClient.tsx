...
export default function FitOutClient() {
    ...
    return (
        <>
            ...
            <section className="relative w-full lg:h-[400px] h-[300px] flex items-center text-center justify-center">
                <Image src={bannerImage} layout="fill" objectFit="cover" alt="Fit Out Banner" />
                    ...
                    <div className="container mx-auto">
                        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                            ...
                            <div className="lg:w-full">
                                <Swiper navigation={true} pagination={{ clickable: true }} modules={[Navigation, Pagination]} spaceBetween={20}
                                    slidesPerView={1.1} className="w-full h-auto" >
                                    {sliderImages.length > 0 ? (sliderImages.map((item: { src: string }, index: number) => (
                                        <SwiperSlide key={index}>
                                            <Image src={item.src} alt={`Slide ${index + 1}`} width={800} height={500} className="object-cover w-full h-full rounded-lg" sizes="(max-width: 768px) 100vw, 50vw" />
                                        </SwiperSlide>
                                    ))
                                    ) : (
                                        <SwiperSlide>
                                            <Image src="/images/05.jpg" alt="Placeholder" width={800} height={500} className="object-cover w-full h-full rounded-lg" sizes="(max-width: 768px) 100vw, 50vw" />
                                        </SwiperSlide>
                                    )}
                                </Swiper>
                            </div>
