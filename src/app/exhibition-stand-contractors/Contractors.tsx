...
export default function Contractors() {
    ...
    const { data } = useQuery(GET_EXHIBITION_CONSTROCTOR_DATA, { variables: { locale }, });
    const mainExhibitionconstroctor = data?.constroctor?.data?.attributes || {};
    ...
    const images = [
        mainExhibitionconstroctor?.image1?.data?.attributes?.url ? `${baseUrl}${mainExhibitionconstroctor.image1.data.attributes.url}` : "/images/exhibition1.png",
        mainExhibitionconstroctor?.image2?.data?.attributes?.url ? `${baseUrl}${mainExhibitionconstroctor.image2.data.attributes.url}` : "/images/exhibition2.png",
        mainExhibitionconstroctor?.image3?.data?.attributes?.url ? `${baseUrl}${mainExhibitionconstroctor.image3.data.attributes.url}` : "/images/exhibition3.png",
        mainExhibitionconstroctor?.image4?.data?.attributes?.url ? `${baseUrl}${mainExhibitionconstroctor.image4.data.attributes.url}` : "/images/exhibition4.png",
    ];
                    ...
                    <div className="container mx-auto">
                        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-8">
                            <div>
                                ...
                                <div className="lg:py-3 py-2 text-sm text-[#3E444A] 3xl:text-base"
